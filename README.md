...
See [AuthPage.jsx](https://github.com/awahl2/webscripting_final/blob/main/src/pages/AuthPage.jsx)
...
export default function MyShelf() {
  ...
  const toggleRead = (id) =>
    setBooks((b) =>
      b.map((x) =>
        x.id === id
          ? { ...x, read: !x.read, rating: x.read ? 0 : x.rating }
          : x,
      ),
    );
  const rateBook = (id, r) =>
    setBooks((b) => b.map((x) => (x.id === id ? { ...x, rating: r } : x)));

  const sortOpts = [
    { v: "title-asc", l: "Title A–Z" },
    { v: "title-desc", l: "Title Z–A" },
    { v: "author-asc", l: "Author A–Z" },
    { v: "author-desc", l: "Author Z–A" },
    { v: "pages-asc", l: "Fewest pages" },
    { v: "pages-desc", l: "Most pages" },
  ];
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            <img
              src={LOGO_SRC}
              alt=""
              style={{ height: "28px", mixBlendMode: "multiply", opacity: 0.5 }}
            />
            <span
              style={{
                fontFamily: "'Lora', serif",
...
See [ShelfPage.jsx](https://github.com/awahl2/webscripting_final/blob/main/src/pages/ShelfPage.jsx)
